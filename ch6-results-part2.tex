\chapter{Results}
	\section{Head-on collisions of Xe and Cs}
		...
		\begin{figure}[!]
			...
			\caption{\label{fig2}Right panel: Dynamic evolution of a Xe atom (big dot) approaching the $^4$He$_{1000}$ droplet from below at $v_0 = 200$ m/s. The corresponding time is indicated in each frame. Left panel: Same as left figure for a Cs atom. (Color figure online.)}
		\end{figure}
...
%that has drawn the interest of physicists and chemists working on atomic, low temperature condensed 
%matter and molecular spectroscopy. 
...
%This cross beam technique was later 
%used to characterize the helium  droplet density  by comparing the 
%measured integral cross section with that predicted by  using droplet density profiles 
%obtained by density functional theory (DFT) calculations.\cite{Har98,Har01}   
...
%While in normal liquid He the coalescence of the captured impurity atoms  leads to the formation of microparticles,
%in the superfluid very long filaments are observed
%due to the trapping of regularly spaced metal clusters along the vortex cores.
%For instance, laser ablation of metals in liquid helium results in the formation of 
%both  metal filaments with diameters on the order of 2-10 nanometers 
%and of spherical nanoparticles. 
%The filaments survive the transition of helium to its 
%normal state, allowing for practical applications in the 
...
%In spite of the relevance of impurities capture by helium droplets, 
%the theoretical activities aiming at a microscopic understanding 
%of the capture process are 
%scarce. 
%They are basically limited to a rather old application of 
%the Nuclear Physics optical model to the 
%scattering of $^4$He atoms by $^4$He droplets\cite{Eic88} and 
%to a microscopic approach to the scattering of $^3$He and $^4$He atoms from inhomogeneous 
%quantum liquids.\cite{Kro07,Kro08} 
...
%in  Bose-Einstein condensates (BEC) made of cold gases.\cite{Fre10}  
%At variance with 
...
%inside the liquid\cite{Anc17} in a geometry often employed 
